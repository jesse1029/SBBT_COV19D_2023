...
if __name__ == '__main__':
    ...
    bin_save_path = "/ssd8/2023COVID19/CT-COVID19-Classification/train_code_fix/model"
    job_name = f"job_{job}_effnetb3a_size{CONFIG['img_size']}_challenge[DataParallel]_146"+".bin"
    print("save path = {}".format(job_name))
    ...
    # pred_path=f'{bin_save_path}/f1/'+job_name
